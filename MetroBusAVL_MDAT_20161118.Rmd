...
AllDays_NewTravelDist <- 
  mutate(AllDays_NewOrder,
         ...
         TravelDistance_Mi_NewHvrs = ifelse(TravelDistance_Mi_New < TD_Mi_q2 |
                                              TravelDistance_Mi_New > TD_Mi_q98,
                                            TravelDistance_Mi_Hvrs,
                                            TravelDistance_Mi_New
                                           ),
         TravelDistance_Mi_NewHvrs_Label = 
           factor(ifelse(TravelDistance_Mi_New < TD_Mi_q2 |
                           TravelDistance_Mi_New > TD_Mi_q98,
                         "TravelDistance_Mi_Hvrs",
                         TravelDistance_Mi_New_Label
                        )
...
TravDistMiNew_Ntile <- as.data.frame(select(AllDays_NewTravelDist,
                                            TravelDistance_Mi_New,
                                            TravelDistance_Mi_NewHvrs
                                           )
                                    ) %>% 
  mutate(# Pctile = ntile(AllDays_NewTravelDist$TravelDistance_Mi_New, 100),
         ...
         PctR_New = percent_rank(AllDays_NewTravelDist$TravelDistance_Mi_New),
         PctR_NewH = percent_rank(AllDays_NewTravelDist$TravelDistance_Mi_NewHvrs),
         PctR_Round_New = round(PctR_New, 2),
         PctR_Round_NewH = round(PctR_NewH, 2)
        ) 
...
rm(TravDistMiNew_Ntile)
rm(TravDistMiNew_Ntile_Rows)
...
filter(AllDays_NewTravelDist,
       is.na(TravelDistance_Mi_New)
       ) %>% 
  group_by(TravelDistance_Mi_New_Label) %>% 
  summarise(CntNum = n()
            # ,
            # CntPct = n() / nrow(filter(AllDays_NewTravelDist,
            #                            is.na(TravelDistance_Mi_New)
            #                           )
            #                    )
           )
