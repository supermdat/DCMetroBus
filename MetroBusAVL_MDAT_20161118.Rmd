...
Stats_StSt <- group_by(Quantiles_SS_dt,
  ...
  summarise(TD_Mi_SS_Mean = mean(TravelDistance_Mi, na.rm = TRUE),
            ...
            TT_Sec_SS_Cnt_F = sum(!is.na(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95]
                                        )
                                 ),
            ...
            TT_Hr_SS_Cnt_F = sum(!is.na(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95]
                                       )
                                )
           )
...
Stats_StSt_HrGrp <- group_by(Quantiles_SSHG_dt,
  ...
  summarise(TD_Mi_SSHG_Mean = mean(TravelDistance_Mi, na.rm = TRUE),
            ...
            TT_Sec_SSHG_Cnt_F = sum(!is.na(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95]
                                          )
                                   ),
            ...
            TT_Hr_SSHG_Cnt_F = sum(!is.na(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95]
                                         )
                                  )
           )
...
rm(ExtremeTravDist)
rm(ExtremeTravDist_Spread)

```


Investigatio of TravelDistance_Mi.
