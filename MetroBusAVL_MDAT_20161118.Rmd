...
Quantiles_SS_dt <- group_by(AllDays_BusDay,
  ...
  mutate(TD_Mi_q5 = quantile(x = TravelDistance_Mi, probs = 0.05, na.rm = TRUE),
         TD_Mi_q95 = quantile(x = TravelDistance_Mi, probs = 0.95, na.rm = TRUE),
         TT_Sec_q5 = quantile(x = TravelTime_Sec, probs = 0.05, na.rm = TRUE),
         TT_Sec_q95 = quantile(x = TravelTime_Sec, probs = 0.95, na.rm = TRUE),
         TT_Hr_q5 = quantile(x = TravelTime_Hr, probs = 0.05, na.rm = TRUE),
         TT_Hr_q95 = quantile(x = TravelTime_Hr, probs = 0.95, na.rm = TRUE)
        ) %>% 
  data.table()
...
Stats_StSt <- group_by(Quantiles_SS_dt,
  ...
  summarise(TD_Mi_SS_Mean = mean(TravelDistance_Mi, na.rm = TRUE),
            TD_Mi_SS_Mean_F = mean(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95],
                                   na.rm = TRUE
                                  ),
            TD_Mi_SS_Med = median(TravelDistance_Mi, na.rm = TRUE),
            TD_Mi_SS_Med_F = median(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95],
                                    na.rm = TRUE
                                   ),
            TD_Mi_SS_Cnt = sum(!is.na(TravelDistance_Mi)
                              ),
            TD_Mi_SS_Cnt_F = sum(!is.na(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95]
                                       )
                                ),
            
            TT_Sec_SS_Mean = mean(TravelTime_Sec, na.rm = TRUE),
            TT_Sec_SS_Mean_F = mean(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95],
                                    na.rm = TRUE
                                   ),
            TT_Sec_SS_Med = median(TravelTime_Sec, na.rm = TRUE),
            TT_Sec_SS_Med_F = median(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95],
                                     na.rm = TRUE
                                    ),
            TT_Sec_SS_Cnt = sum(!is.na(TravelTime_Sec)),
            TD_Sec_SS_Cnt_F = sum(!is.na(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95]
                                        )
                                 ),

            TT_Hr_SS_Mean = mean(TravelTime_Hr, na.rm = TRUE),
            TT_Hr_SS_Mean_F = mean(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95],
                                    na.rm = TRUE
                                   ),
            TT_Hr_SS_Med = median(TravelTime_Hr, na.rm = TRUE),
            TT_Hr_SS_Med_F = median(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95],
                                    na.rm = TRUE
                                   ),
            TT_Hr_SS_Cnt = sum(!is.na(TravelTime_Hr)),
            TD_Hr_SS_Cnt_F = sum(!is.na(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95]
                                       )
                                )
           )
...
Quantiles_SSHG_dt <- group_by(AllDays_BusDay,
                              StartStop_ID,
                              Event_Time_HrGroup
                             ) %>% 
  mutate(TD_Mi_q5 = quantile(x = TravelDistance_Mi, probs = 0.05, na.rm = TRUE),
...
Stats_StSt_HrGrp <- group_by(Quantiles_SSHG_dt,
  ...
  summarise(TD_Mi_SSHG_Mean = mean(TravelDistance_Mi, na.rm = TRUE),
            TD_Mi_SSHG_Mean_F = mean(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95],
                                     na.rm = TRUE
                                    ),
            TD_Mi_SSHG_Med = median(TravelDistance_Mi, na.rm = TRUE),
            TD_Mi_SSHG_Med_F = median(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95],
                                      na.rm = TRUE
                                     ),
            TD_Mi_SSHG_Cnt = sum(!is.na(TravelDistance_Mi)
                                ),
            TD_Mi_SSHG_Cnt_F = sum(!is.na(TravelDistance_Mi[TD_Mi_q5 <= TravelDistance_Mi & TravelDistance_Mi <= TD_Mi_q95]
                                         )
                                  ),
            
            TT_Sec_SSHG_Mean = mean(TravelTime_Sec, na.rm = TRUE),
            TT_Sec_SSHG_Mean_F = mean(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95],
                                      na.rm = TRUE
                                     ),
            TT_Sec_SSHG_Med = median(TravelTime_Sec, na.rm = TRUE),
            TT_Sec_SSHG_Med_F = median(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95],
                                       na.rm = TRUE
                                      ),
            TT_Sec_SSHG_Cnt = sum(!is.na(TravelTime_Sec)),
            TD_Sec_SSHG_Cnt_F = sum(!is.na(TravelTime_Sec[TT_Sec_q5 <= TravelTime_Sec & TravelTime_Sec <= TT_Sec_q95]
                                          )
                                   ),

            TT_Hr_SSHG_Mean = mean(TravelTime_Hr, na.rm = TRUE),
            TT_Hr_SSHG_Mean_F = mean(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95],
                                     na.rm = TRUE
                                    ),
            TT_Hr_SSHG_Med = median(TravelTime_Hr, na.rm = TRUE),
            TT_Hr_SSHG_Med_F = median(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95],
                                      na.rm = TRUE
                                     ),
            TT_Hr_SSHG_Cnt = sum(!is.na(TravelTime_Hr)),
            TD_Hr_SSHG_Cnt_F = sum(!is.na(TravelTime_Hr[TT_Hr_q5 <= TravelTime_Hr & TravelTime_Hr <= TT_Hr_q95]
                                         )
                                  )
           )
...
Join Stats_StSt and Stats_StSt_HrGrp with AllDays_BusDay
```{r}

AllDays_wSumStats <- left_join(AllDays_BusDay,
                               Stats_StSt,
                               by = c("StartStop_ID" = "StartStop_ID")
                              ) %>% 
  left_join(Stats_StSt_HrGrp,
            Stats_StSt,
            by = c("StartStop_ID" = "StartStop_ID",
                   "Event_Time_HrGroup" = "Event_Time_HrGroup"
                  )
           )

# dim(AllDays_BusDay)
# dim(AllDays_wSumStats)

rm(AllDays_BusDay)
rm(Stats_StSt)
rm(Stats_StSt_HrGrp)

str(AllDays_wSumStats)

summary(AllDays_wSumStats)
...
AllDays_BusDayRoute <- group_by(AllDays_wSumStats,
                                Bus_ID,
                                Event_Time_Date,
                                Route
                               ) %>% 
...
TravDistMi_HistDen <- ggplot(TravelDistance_Mi_NoNA, aes(x = TravelDistance_Mi,
                                                         y = ..density..
                                                        )
                            ) +
  geom_histogram(binwidth = 0.05, fill = "lightblue", colour = "grey60", size = 0.2) +
  geom_line(stat = "density", colour = "red") +
  coord_cartesian(xlim = c(0, 1.5), ylim = c(0, 3.5)
                 ) +  # 0.0001893939 is the value at the 11th percentile (& the 1st percentile with non-zero values)
                      # 1.0812500000 is the 99th percentile
  xlab("Travel Distance (miles)") + 
  ylab("Density") + 
  #  theme(legend.position="none") + 
  ggtitle(expression(atop("Variation in Distance Between Stops"
                          # ,atop(italic("xxxxx"),"")
                         )
                    )
         )
...
View(filter(AllDays_NewOrder,
            TravelDistance_Mi > 1 # 1.0812500000 is the 99th percentile
           ) %>% 
...
ExtremeTravDist <- filter(AllDays_NewOrder,
  ...
  mutate(TravDist_Extreme = ifelse(TravelDistance_Mi > 1,
                                   "True",
                                   "False"
                                  )
                          ) %>% 
...
DistByBus <- group_by(AllDays_NewOrder,
                      Bus_ID
                     ) %>% 
...
View(arrange(DistByBus,
             desc(DistTrav_Med)
            )
    )

# head(AllDays_NewOrder)
...
TravelDistance_Mi_Hvrs is based on the Haversine (great circle) distance, and TravelDistance_Mi_New uses TravelDistance_Mi_Hvrs when TravelDistance_Mi == 0 or when TravelDistance_Mi is > 1.0812500000 (the 99th percentile of TravelDistance_Mi)
```{r}

AllDays_NewTravelDist <- mutate(AllDays_NewOrder,
                                TravelDistance_Mi_New = ifelse(TravelDistance_Mi == 0,
                                                               TravelDistance_Mi_Hvrs,
                                                        ifelse(TravelDistance_Mi > 1.0812500000, # 1.0812500000 is the 99th percentile
                                                               TravelDistance_Mi_Hvrs,
                                                               TravelDistance_Mi
                                                              )),
                                SpeedAvg_Mph2 = ifelse(TravelTime_Hr > 0,
                                                       TravelDistance_Mi_New / TravelTime_Hr,
                                                       NA
                                                      )
                               )
...
TravDist_Corr <- as.matrix(cor(x = AllDays_NewTravelDist$TravelDistance_Mi_Hvrs,
                               y = AllDays_NewTravelDist$TravelDistance_Mi,
                               use = "pairwise"
                              )
                          )
...
AllDays_NewTravelDist_10Pct <- filter(AllDays_NewTravelDist,
  ...
  mutate(DistCalcMethod = factor(ifelse(TravelDistance_Mi == 0 |
                                          TravelDistance_Mi > 1.0812500000,
                                        "Outlier",
                                        "Normal"
                                       )
                                )
...
TravDist_MiVsCalc <- ggplot(AllDays_NewTravelDist_10Pct,
                            aes(x = TravelDistance_Mi_Hvrs,
                                y = TravelDistance_Mi,
                                colour = DistCalcMethod
                               )
                           ) +
  geom_point(shape = 1, alpha = 0.5) +
  scale_shape(solid = FALSE) +
  ...
  annotate(label = lm_eqn(df = AllDays_NewTravelDist_10Pct,
                          ...
                          x = AllDays_NewTravelDist_10Pct$TravelDistance_Mi_Hvrs
                         ),
           # x = 62,
           # y = 20,
           x = 0.95,
  ...
  labs(title = "TravelDistance_Mi vs. TravelDistance_Mi_Hvrs",
       x = "TravelDistance_Mi_Hvrs",
       y = "TravelDistance_Mi"
      )
# +
#   geom_jitter()
...
TravDist_MiVsCalc_Bokeh <- figure(data = AllDays_NewTravelDist_10Pct,
                                  xlim = c(0, 1.5),
                                  ylim = c(0, 1.5),
                                  legend_location = "bottom_right"
                                 ) %>% 
  ly_points(x = TravelDistance_Mi_Hvrs,
            y = TravelDistance_Mi,
            color = DistCalcMethod,
            hover = c(TravelDistance_Mi_Hvrs, TravelDistance_Mi)
           ) %>% 
...
~23% of rides are still showing as less than 0.1 miles of TravelDistance_Mi_New.
```{r}

summary(AllDays_NewTravelDist$TravelDistance_Mi_New)

TravDistMiNew_Ntile <- as.data.frame(AllDays_NewTravelDist$TravelDistance_Mi_New) %>% 
  mutate(Pctile = ntile(AllDays_NewTravelDist$TravelDistance_Mi_New, 100),
         MinR = min_rank(AllDays_NewTravelDist$TravelDistance_Mi_New),
         PctR = percent_rank(AllDays_NewTravelDist$TravelDistance_Mi_New),
         PctR_Round = round(PctR, 2)
        ) 

colnames(TravDistMiNew_Ntile)[1] <- "TravelDistance_Mi_New"
str(TravDistMiNew_Ntile)

TravDistMiNew_Ntile_Rows <- nrow(TravDistMiNew_Ntile)

View(tail(TravDistMiNew_Ntile, 500))
...
TravDistMiNew_Pctiles <- group_by(TravDistMiNew_Ntile,
  ...
  summarise(
    MinTravDistMiAtPctile = min(TravelDistance_Mi_New),
    CntsAtPctile = n(),
    PctsAtPctile = CntsAtPctile / TravDistMiNew_Ntile_Rows
  ) %>% 
  mutate(CumSumPAtP = cumsum(PctsAtPctile)
        )
...
# examples of TravelDistance_Mi_New values that are zero.
View(filter(AllDays_NewTravelDist,
            (RowNum_OG >= 1652 & RowNum_OG <= 1672) | # 1662  --  1st trip of a new route & no change in lat lon
                (RowNum_OG >= 92378 & RowNum_OG <= 92398) | # 92388  --  odometer always at zero & no change in lat lon
                (RowNum_OG >= 1447462 & RowNum_OG <= 1447482) | # 1447472  --  no change in odometer & no change in lat lon
                (RowNum_OG >= 1485845 & RowNum_OG <= 1485865) # 1485855  --  no change in odometer & no change in lat lon
           )
    )
...
View(filter(AllDays_NewTravelDist,
            TravelDistance_Mi_New > 0 &
              TravelDistance_Mi_New < 0.0984848485 &  # 0.0984848485 is an MDAT guess at a distance between stops
              TravelDistance_Ft == 0  # meaning TravelDistance_Mi_New is based on Haversine distance (lat long values)
           ) %>% 
       arrange(TravelDistance_Mi_New)
    )

# examples of TravelDistance_Mi_New values that are very small. All are examples of no change in the odometer, and extremely small changes in lat lon.
View(filter(AllDays_NewTravelDist,
            (RowNum_OG >= 921036 & RowNum_OG <= 921056) | # 921046  --  
                (RowNum_OG >= 2281235 & RowNum_OG <= 2281255) | # 2281245  --  
                (RowNum_OG >= 2956528 & RowNum_OG <= 2956548) | # 2956538  --  
                (RowNum_OG >= 2909007 & RowNum_OG <= 2909027) # 2909017  --  
           )
    )
...
View(filter(AllDays_NewTravelDist,
            TravelDistance_Mi_New > 0 &
              TravelDistance_Mi_New < 0.0984848485 &  # 0.0984848485 is an MDAT guess at a distance between stops
              TravelDistance_Ft != 0  # meaning TravelDistance_Mi_New is based on actual odometer readings
           ) %>% 
       arrange(TravelDistance_Mi_New)
    )

# examples of TravelDistance_Mi_New values that are very small. All are examples of extremely small changes in the odometer.
View(filter(AllDays_NewTravelDist,
            (RowNum_OG >= 1681 & RowNum_OG <= 1701) | # 1691  --  
                (RowNum_OG >= 2131 & RowNum_OG <= 2151) | # 2141  --  
                (RowNum_OG >= 154784 & RowNum_OG <= 154804) | # 154794  --  
                (RowNum_OG >= 2267431 & RowNum_OG <= 2267451) # 2267441  --  
           )
    )
