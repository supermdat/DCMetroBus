...
#   }
# }
for(i in 1:975 #1950 #(nrow(LL_Stats)-9950)
   ){
  lat <- filter(LL_Stats,
                RowNum == (i + 975)
               ) %>%
  ...
  message("Retrieving Zip Code ", (i + 975)
         )
...
Zips_All <- bind_rows(#Zips,
  ...
  mutate(UniqueLatLng = paste(lat, lng, sep = "--")
        )
...
View(filter(Zips_All,
            UniqueLatLng == "38.931858---77.036911"
           )
    )
