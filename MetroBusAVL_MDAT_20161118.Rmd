...
kmeans method. Particularly looking at silhouette statistics.
```{r}
...
for(i in 2:15) {
  ...
  assign(paste("HCDend_K", i),
         fviz_dend(x, rect = TRUE, show_labels = FALSE)
        )
  
  assign(paste("HCSil_K", i),
         fviz_silhouette(x)
        )
...
HCStats_K2$clus.avg.silwidths
HCStats_K3$clus.avg.silwidths

# rm(HC_Res_2, HC_Res_3, HC_Res_4, HC_Stats_2, HC_Stats_3, HC_Stats_4)
